...
#criando janela e configurações basicas

janela = Tk()
janela.title("Calculadora")

#largura e comprimento janela
janela.geometry("235x310")
janela.config(bg=cor1)

#dividindo display e botões
...
b_18 = Button(frame_corpo, command = calculo,text="=", width=5, height=2, bg=cor5, fg=cor2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_18.place(x=177, y=208)


#codigo baseado no video: https://youtu.be/i24MxljM-Bw
janela.mainloop()